...
public class Product1 {
	...
	transient private List<Category> categoryList = new ArrayList<Category>();
	...
	public Product1(Integer productId, String productCode, String description, Float price, Date manfDate) {
		super();
		this.productId = productId;
		this.productCode = productCode;
		this.description = description;
