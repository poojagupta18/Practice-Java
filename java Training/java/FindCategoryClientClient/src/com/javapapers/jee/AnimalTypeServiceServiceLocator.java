...
public class AnimalTypeServiceServiceLocator extends org.apache.axis.client.Service implements com.javapapers.jee.AnimalTypeServiceService {
    ...
    private java.lang.String AnimalTypeService_address = "http://localhost:8080/FindCategoryClient/services/AnimalTypeService";
    ...
    public com.javapapers.jee.AnimalTypeService getAnimalTypeService() throws javax.xml.rpc.ServiceException {
    ...
    public com.javapapers.jee.AnimalTypeService getAnimalTypeService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.javapapers.jee.AnimalTypeServiceSoapBindingStub _stub = new com.javapapers.jee.AnimalTypeServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.javapapers.jee.AnimalTypeService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.javapapers.jee.AnimalTypeServiceSoapBindingStub _stub = new com.javapapers.jee.AnimalTypeServiceSoapBindingStub(new java.net.URL(AnimalTypeService_address), this);
                _stub.setPortName(getAnimalTypeServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://jee.javapapers.com", "AnimalTypeServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://jee.javapapers.com", "AnimalTypeService"));
        }
